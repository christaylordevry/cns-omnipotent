...
> Version: 1.2.1 | Last updated: 2026-04-02  
...
| Date | Version | Change |
|------|---------|--------|
| 2026-04-02 | 1.2.1 | Section 4: explicit **Search scope** guidance (task-default directories, whole-vault when needed); clarify judgment vs optional MCP search defaults. |
