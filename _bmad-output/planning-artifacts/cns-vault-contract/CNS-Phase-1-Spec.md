...
Behavior:
  ...
  - Routes to correct folder based on pake_type:
      ...
      WorkflowNote  -> 01-Projects/ (requires project context) or 02-Areas/
...
- **Discord / Nexus surface** connects to the Vault IO layer (Nexus sends commands, vault IO executes, results return to Discord)
