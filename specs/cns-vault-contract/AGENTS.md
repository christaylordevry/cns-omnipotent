...
> Version: 2.1.13 | Last updated: 2026-05-28
...
- 42-10-vault-search: Story 42.10: Vault search (Convex query + panel + Obsidian handoff) shipped as done.
- 29-10-hermes-thinking-commands: Story 29.10: Hermes thinking commands (`vault-think`) shipped as done.
- 9-1-shared-pake-type-module-for-mcp-and-validation: Story 9.1: Shared PAKE type module for MCP and validation (Epic B — Phase 2.0) shipped as done.
