...
> Version: 2.1.16 | Last updated: 2026-05-29
...
| Date | Version | Change |
|------|---------|--------|
| 2026-05-29 | 2.1.16 | Story 28.1: Section 8 regenerated by Hermes `/session-close`; current focus now derives from sprint-status.yaml and recent story artifacts. |
