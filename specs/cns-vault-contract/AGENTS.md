...
> Version: 2.1.44 | Last updated: 2026-06-24
...
- Epic 73: in-progress (no stories tracked yet)
- Epic 76: in-progress; story 76-1 (session-close orientation artifact refresh) ready-for-dev

### Current Priorities

1. Review and close Story 74.8 (Portal and Desktop governance documentation — currently in review).
2. Start Story 76-1 (session-close orientation artifact refresh — ready-for-dev).
3. Define and track stories for Epic 73.

### Recent Session Context

- Story 74.8: Portal and Desktop governance documentation — in review (baseline dd74547)
- Story 74.7: Hermes Desktop live chat connection — done (baseline d3f83fd)
- Story 74-8 governance evidence artifact — produced during review
