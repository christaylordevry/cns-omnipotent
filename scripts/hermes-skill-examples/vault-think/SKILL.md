---
name: vault-think
description: "Hermes CNS vault cognition for #hermes: /challenge, /emerge, /ideas, /today, /ghost, /drift (Vault IO read-only); /trace, /connect (Obsidian Local REST API)."
version: 1.2.0
author: CNS Operator
license: MIT
metadata:
...
# Hermes CNS `vault-think` (Story 29-10, 31-3, 32-3)
...
2. Classify the operator line: v1.0 command, v1.1 live (`/trace`, `/connect`), v1.2 (`/ghost`, `/drift`), `/today`, or bad trigger.
